...
export const productsData: Product[] = [
  ...
  },
  {
    ...
    editorVerdict: "因风靡全球的Strider杯竞技赛而成为大部分家庭眼中的熟面孔。虽然极其经骑耐磨且无需气筒，但EVA胎极易侧摔的抓地隐患不容忽视，建议在晴天且平滑干燥塑胶道驾驶。",
    imageUrl: ""
  },
  ...
  // ==================== Kids Electric Cars (儿童电动车) ====================
  {
    ...
    editorVerdict: "来自意大利大牌原装，通过最严苛的儿童电学防发热和电池阻抗穿刺认证。其起步的重力缓扭曲线极富工效学，杜绝了低端杂牌电动车‘一踩油门瞬间弹射导致幼童颈部挫伤’的致命弊病。",
    imageUrl: ""
  },
  {
    id: "elec_2",
  ...
  // ==================== Cross-border Special (跨境专属款) ====================
  {
    id: "cross_1",
    name: "Cleary Bikes Owl 16 纯美标防撞倒踩刹山地童车",
    brand: "Cleary Bikes (美国)",
    category: "cross_border",
    wheelSize: "16寸",
    weight: 7.4,
    material: "极致抗冲击4130铬钼钢 (越野车架之母)",
    brakeType: "美国CPSC法定后轮同轴脚踏倒刹 (Coaster)",
    tireType: "Kenda K-Rad 2.125'' 沙石越野重咬合胎",
    price: 2980,
    ageRange: "4 - 6 岁",
    heightRange: [102, 118],
    safetyCertification: ["CPSC (美国消费强制测试规)", "ISO 8098"],
    safetyScore: 8.8,
    geometryScore: 9.4,
    weightScore: 8.5,
    overallScore: 8.9,
    pros: [
      "采用4130高档经典铬钼管，天然吸震钢架，在越野林地中路面弹性手感第一",
      "极窄的Q-Factor（只有112mm），宝宝大盆骨腿不外张，完美工效踩踏几何",
      "高品质 Tektro 人类小手一指精微手刹卡持"
    ],
    cons: [
      "强制装配了连杆式的脚踩后退锁死倒刹，这对非美籍中国儿童在初学自行车时往往需要长达一个月对蹬退就锁死习性的痛苦调适",
      "原厂座高不可大幅调高，偏向竞技速降的定重几何"
    ],
    editorVerdict: "Cleary Owl 在北美是非常知名的中立级高端山地车型。使用超高端的美国工业越野钢材铬钼钢打造，极为耐打坏。如果你要搬家去美国入托骑行，这款100%符贴美制海关合规的车型将是你的极佳战马。",
    imageUrl: ""
  },

  // ==================== Industrial Belt (产业带品牌产品) ====================
  {
    id: "belt_1",
    name: "Ninenoble 九能「青追」一体压铸镁超轻童车 (14寸)",
    brand: "Ninenoble九能 (中国·平乡制造)",
    category: "industrial_belt",
    wheelSize: "14寸",
    weight: 5.3,
    material: "一体式镁合金无缝高强度压铸车身 (高密度涂装)",
    brakeType: "微调微间拉线小手刹 (带高阻后鼓自锁安全防咬)",
    tireType: "超轻越野高阻抓地气橡胶轮胎",
    price: 499,
    ageRange: "3 - 5 岁",
    heightRange: [95, 115],
    safetyCertification: ["GB 14746 (国标高标)", "CCC (国家3C强制检测核验)"],
    safetyScore: 9.5,
    geometryScore: 9.4,
    weightScore: 9.8,
    overallScore: 9.6,
    pros: [
      "颠覆行业性价比壁垒！首家做到 5.3kg 却只需不到 500 元人民币即可出海的产品",
      "无鱼鳞接焊缝的一体压铸高强度航空级镁合金，防爆裂、断轴、裂痕刚性极其强悍",
      "幼童特配线拉手拉杆，相比大部分国产笨重手刹，捏动力量要求减少了45%"
    ],
    cons: [
      "车把及立管氧化着漆在烈日持久照射下（如长达几个月大太阳暴照），其部分亮漆有由于热膨胀系数微小退色剥落痕迹",
      "副侧防掀侧轮在水泥地面过障时钢制侧架稍偏软，大体重儿童转速极快时会有轻微回声响动"
    ],
    editorVerdict: "本站对标奥地利 Woom 2 精英大热产品后，极度推荐给普通预算中产家庭的‘产业带终极高性比奇迹’。它利用平乡先进的45秒液压镁铸成型供应链，一举解决国产车架‘太沉拖累宝宝骨脊发育、刹手把太大孩子手抓不动、做工糙劣刺伤娇肤’的三大黑点，堪称中国智造崛起代表作。",
    imageUrl: ""
  }
];
