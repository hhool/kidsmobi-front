...
const PAGE_COPY: Record<Locale, PageCopy> = {
  zh: {
    home: {
      ...
      heroTitle: "欢迎来到 BalanceBikeToddler，我们聚焦 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars 的全球评测数据。",
      heroSubtitle: "围绕 balance bike、kids bikes、jogging stroller、kids electric scooter、kids electric cars 的独立实验室物理安全检测、对比和选购建议，持续更新首页精选内容。",
      ...
      categoryHighlights: {
        eyebrow: "精选品类",
        title: "按品类探索：balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars",
      ...
      categoryCards: {
        strollerLabel: "慢跑手推车",
        strollerDesc: "发现我们评分领先的 jogging stroller 与慢跑手推车，经过全地形悬挂、安全刹车及宝宝舒适度的严格实验室测试。",
        balanceLabel: "儿童平衡车",
        balanceDesc: "为您的 balance bike 寻找最安全的平衡车。我们评估车架重量、轮胎抓地力和人体工学，帮助他们自信骑行。",
        kidsBikeLabel: "儿童自行车",
        kidsBikeDesc: "比较最优秀的 kids bikes 与 12 英寸至 16 英寸儿童自行车。我们的中立评测聚焦于制动力学、车架几何与脚踏稳定性。",
        scooterLabel: "儿童滑板车",
        scooterDesc: "探索我们经专业评测的 kids electric scooter 与儿童滑板车系列。从稳定的三轮车到灵敏的两轮车，我们测试踏板强度和转向安全设计。",
        electricCarLabel: "四轮儿童电动车",
        electricCarDesc: "评测领先的 kids electric cars 与电池驱动儿童玩具车。我们对机电机理、遥控保护与减震安全性等指标进行专项验证。",
        carSeatLabel: "儿童安全座椅",
      ...
      safetyAudits: {
        ...
        description: "下方每一款 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars，均已通过高冲击应力评测与安全阈值评级。",
        viewAudits: "查看安全评测报告",
        morePicks: "更多精选推荐",
        noElectricData: "暂无电动车评测数据，敬请期待",
        sections: {
          joggingTitle: "最佳 jogging stroller",
          joggingDesc: "精选高安全性能 jogging stroller，深度测评全地形悬挂避震与车胎稳定性设计。",
          balanceTitle: "最佳 balance bike",
          balanceDesc: "专为幼童打造的 balance bike 测评，聚焦轮胎防滑、防侧翻限位及脚踏高度配置。",
          kidsBikeTitle: "最佳 kids bikes",
          kidsBikeDesc: "精选 12-16 英寸高安全评分 kids bikes，严苛测试制动距离与车架刚度。",
          scooterTitle: "最佳 kids electric scooter",
          scooterDesc: "针对幼童与大童的 kids electric scooter 评测，重点聚焦重力转向及防空转安全垫片。",
          electricCarTitle: "最佳 kids electric cars",
          electricCarDesc: "全方位 kids electric cars 遥控模拟舱测试，着重实测双向避震、缓启冲阻性及电池管理系统。",
        },
      },
      quickScenarios: {
        title: "智能选购场景",
        description: "从 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars 的成长阶段出发，为您快速匹配最佳方案。",
        cards: {
      ...
      faq: {
        badge: "常见问题",
        title: "常见问题与解答",
        description: "为您解答关于 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars 测试标准的常见问题。",
        items: [
          {
  ...
  en: {
    home: {
      ...
      heroTitle: "BalanceBikeToddler: Trusted Global Reviews on Balance Bike, Kids Bikes, Jogging Stroller, Kids Electric Scooter & Kids Electric Cars",
      heroSubtitle: "The best balance bike, kids bikes, jogging stroller, kids electric scooter, and kids electric cars, independently tested for safety and performance.",
      ...
      categoryHighlights: {
        ...
        title: "Explore by Category: Balance Bike, Kids Bikes, Jogging Stroller, Kids Electric Scooter & Kids Electric Cars",
        description: "We compare frame ergonomics and stress tolerances across balance bike, kids bikes, jogging stroller, kids electric scooter, and kids electric cars parameters.",
        openProductCenter: "Open Product Center",
        featuredTag: "Featured",
      },
      categoryCards: {
        strollerLabel: "Jogging Stroller",
        strollerDesc: "Discover our top-rated jogging stroller picks, rigorously lab-tested for all-terrain suspension, secure braking, and ultimate child comfort during your jogging stroller runs.",
        balanceLabel: "Balance Bike",
        balanceDesc: "Find the safest balance bike for your toddler. We evaluate frame weight, tire grip, and ergonomics to help them learn balance bike riding with confidence.",
        kidsBikeLabel: "Kids Bikes",
        kidsBikeDesc: "Compare the best 12-inch to 16-inch kids bikes models. Our unbiased reviews focus on kids bikes braking power, structural geometry, and pedal stability.",
        scooterLabel: "Kids Electric Scooter",
        scooterDesc: "Explore our expertly reviewed kids electric scooter selection. From stable 3-wheelers to agile 2-wheelers, we test for deck strength and steering safety.",
      ...
      safetyAudits: {
        ...
        sections: {
          ...
          joggingDesc: "Discover the safest high-performance jogging stroller, meticulously evaluated for all-terrain shock absorption and jogging stroller stability.",
          balanceTitle: "Best Balance Bike",
          balanceDesc: "Safest toddler-friendly balance bike. We test balance bike handle grips, turning limiters, and frame weights.",
          kidsBikeTitle: "Best Kids Bikes",
          kidsBikeDesc: "Curated 12-16 inch kids bikes models. Rigorously tested for kids bikes pedal stability, frame geometry and stopping power.",
      ...
      faq: {
        ...
        description: "Answering your questions on balance bike, kids bikes, jogging stroller, kids electric scooter, and kids electric cars testing standards and safe selection guidelines.",
        items: [
          {
