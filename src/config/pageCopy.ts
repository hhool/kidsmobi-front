...
const PAGE_COPY: Record<Locale, PageCopy> = {
  zh: {
    home: {
      ...
      categoryCards: {
        strollerLabel: "婴儿慢跑手推车",
        strollerDesc: "发现我们评分领先的慢跑婴儿车，经过全地形悬挂、安全刹车及宝宝舒适度的严格实验室测试。",
        balanceLabel: "儿童平衡车",
        balanceDesc: "为您的幼儿寻找最安全的平衡车。我们评估车架重量、轮胎抓地力和人体工学，帮助他们自信骑行。",
        kidsBikeLabel: "儿童自行车",
      ...
      safetyAudits: {
        ...
        sections: {
          joggingTitle: "最佳慢跑婴儿车",
          joggingDesc: "精选高安全性能慢跑婴儿车，深度测评全地形悬挂避震与车胎稳定性设计。",
          balanceTitle: "最佳平衡车",
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "低价劣质童车为节省开模费用，常粗暴套用成人五通中轴总成。偏宽的 Q-Factor（脚踏左右偏距宽度）会强行拉开幼儿大腿骨，踩踏时膝关节被迫向内侧严重扣折（形成内八或X型腿趋势），导致髌骨关节面在发育初期的软骨阶段发生不可逆磨损。此外，实心发泡轮胎（EVA）由于没有任何物理空气微孔弹性吸收，产生的3.8G以上高频振荡波会直击大脑、前庭及未发育成熟的椎骨骨骺，干扰神经感知并阻碍发育。",
          },
        ],
      },
      runtimeLabels: {
    ...
    products: {
      ...
      ageLabel: "适龄跨度",
      ageOptions: { all: "全部", baby: "婴幼儿", toddler: "小童", child: "中大童" },
      priceLabel: "预算区间",
      ...
      businessCopy: {
        ...
        generatedSummary: {
          ...
          balanceZh: "幼儿平衡车入门选择，帮助建立低速控车、转向协调与初期骑行信心。",
    ...
    reviews: {
      ...
      sections: {
        ...
        bikeTitle: "经典踩踏：幼儿脚踏自行车深度评测",
        bikeDesc: "大童脚踏车精品测试：JOYSTAR、Cubsala-BMX 与 Glerc 等型号。",
        balanceTitle: "幼儿学跑：平衡车深度评测",
      ...
      businessCopy: {
        ...
        verdictTemplates: {
          ...
          balanceZh: "【实验室评测】{brand} 幼儿平衡车在安全转弯限位与重心分布上表现极为优秀。总体得分 {rating}，非常有利于宝宝四肢骨骼和平衡觉早期发育。",
  ...
  en: {
    home: {
      ...
      categoryCards: {
        ...
        electricCarLabel: "4-Wheel Kids Electric Car",
    ...
    reviews: {
      ...
      sections: {
        strollerTitle: "Kids Stroller Reviews: Travel Stroller & Jogging Stroller Tests",
        ...
        bikeTitle: "Toddler Bike Reviews: Biomechanical & Ride Ratings",
        ...
        balanceTitle: "Balance Ride Reviews: Biomechanical & Weight Ratings",
        ...
        scooterTitle: "Kids Scooter Reviews: Steering & Deck Strength",
        ...
        electricTitle: "Kids Electric Car Reviews: Safety Circuits & Battery Audits",
