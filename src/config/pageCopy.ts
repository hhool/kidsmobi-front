...
const PAGE_COPY: Record<Locale, PageCopy> = {
  zh: {
    home: {
      ...
      heroSubtitle: "从 balance bike、kids bikes、jogging stroller、kids electric scooter 到 kids electric cars，这里持续更新独立实验室的安全检测、对比结果和选购建议。",
      ...
      categoryHighlights: {
        ...
        description: "我们围绕 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars，对车架人体工学、结构耐受与家庭适配度进行对比评估。",
        openProductCenter: "进入产品中心",
        featuredTag: "精选",
      },
      categoryCards: {
        strollerLabel: "慢跑手推车",
        strollerDesc: "发现我们评分领先的 jogging stroller 与慢跑手推车，重点测试全地形悬挂、安全刹车及日常推行舒适度。",
        balanceLabel: "儿童平衡车",
        balanceDesc: "为您的 balance bike 寻找最安全的平衡车。我们评估车架重量、轮胎抓地力和人体工学，帮助 2-3 岁孩子自信起步。",
        kidsBikeLabel: "儿童自行车",
        kidsBikeDesc: "比较最优秀的 kids bikes 与 12 英寸至 16 英寸儿童自行车，聚焦制动力学、车架几何与脚踏稳定性。",
        scooterLabel: "儿童滑板车",
        scooterDesc: "探索我们经专业评测的 kids electric scooter 与儿童滑板车系列，重点看踏板强度、转向安全和低速稳定性。",
        electricCarLabel: "四轮儿童电动车",
        electricCarDesc: "评测领先的 kids electric cars 与电池驱动儿童玩具车，专项验证电池保护、遥控限速与减震表现。",
        carSeatLabel: "儿童安全座椅",
      ...
      safetyAudits: {
        ...
        description: "下方每一款产品都通过高冲击应力评测与安全阈值评级，覆盖 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars 的不同使用场景。",
        viewAudits: "查看安全评测报告",
        morePicks: "更多精选推荐",
        noElectricData: "暂无电动车评测数据，敬请期待",
        sections: {
          joggingTitle: "最佳 jogging stroller",
          joggingDesc: "精选适合 travel 与 daily walk 的 jogging stroller，深度测评悬挂避震、轮胎稳定性与收纳便利度。",
          balanceTitle: "最佳 balance bike",
          balanceDesc: "专为幼童打造的 balance bike 测评，聚焦轮胎防滑、防侧翻限位、脚踏高度和 2 岁入门体验。",
          kidsBikeTitle: "最佳 kids bikes",
          kidsBikeDesc: "精选 12-16 英寸 kids bikes，严苛测试制动距离、车架刚度与日常通勤耐用性。",
          scooterTitle: "最佳 kids electric scooter",
          scooterDesc: "针对幼童与大童的 kids electric scooter 评测，重点聚焦重力转向、低速稳定与安全骑行反馈。",
          electricCarTitle: "最佳 kids electric cars",
          electricCarDesc: "全方位 kids electric cars 测试，着重实测双向避震、缓启冲阻性、电池管理系统与安全限速。",
        },
      },
      quickScenarios: {
        title: "智能选购场景",
        description: "从 balance bike 入门到 kids electric cars 进阶，我们按成长阶段和使用场景帮助您快速匹配最佳方案。",
        cards: {
      ...
      faq: {
        badge: "常见问题",
        title: "常见问题与解答",
        description: "为您解答关于 balance bike、kids bikes、jogging stroller、kids electric scooter 与 kids electric cars 的年龄选择、旅行场景与安全标准问题。",
        items: [
          {
            question: "2 岁宝宝适合哪种 balance bike？",
            answer: "优先选择低坐高、轻车架、轮距稳定的 balance bike。对于刚开始接触骑行的 2-3 岁孩子，入门款更重要的是容易上手、容易停稳，而不是复杂配置。",
          },
          {
            question: "旅行时怎么选轻便 jogging stroller？",
            answer: "优先看可单手折叠、重量更轻、前轮锁定稳定的 jogging stroller，并确认收纳尺寸适合车尾箱或短途旅行使用。",
          },
          {
