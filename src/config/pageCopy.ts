...
const PAGE_COPY: Record<Locale, PageCopy> = {
  ...
  en: {
    home: {
      ...
      heroTitle: "BalanceBikeToddler: Trusted Global Reviews on Best Kids Bikes, Strollers & Wheeled Toys",
      ...
      categoryHighlights: {
        ...
        description: "We compare frame ergonomics and stress tolerances across jogging stroller and kids bikes parameters.",
