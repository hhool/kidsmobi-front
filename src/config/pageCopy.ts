...
const PAGE_COPY: Record<Locale, PageCopy> = {
  zh: {
    home: {
      ...
      heroSubtitle: "从平衡车到儿童自行车、推车、滑板车与儿童电动车，这里持续更新独立实验室的安全检测、对比结果和选购建议。",
      ...
      categoryHighlights: {
        ...
        description: "围绕儿童骑行出行的各个阶段——无脚踏启蒙车、首台脚踏车、推车、滑板车与电池驱动的电动车，对车架人体工学、结构耐受与家庭适配度进行对比评估。",
      ...
      categoryCards: {
        ...
        kidsBikeLabel: "儿童自行车",
        kidsBikeDesc: "比较优秀的儿童自行车与 12 英寸至 16 英寸车型，聚焦制动力学、车架几何与脚踏稳定性。",
        scooterLabel: "儿童滑板车",
        scooterDesc: "探索我们经专业评测的儿童滑板车系列，覆盖脚滑与电动两类，重点看车架强度、转向安全和低速稳定性。",
        electricCarLabel: "四轮儿童电动车",
        electricCarDesc: "评测领先的儿童电动汽车与电池驱动玩具车，专项验证电池保护、遥控限速与减震表现。",
        carSeatLabel: "儿童安全座椅",
      ...
      safetyAudits: {
        ...
        description: "下方每一款产品都通过高冲击应力评测与安全阈值评级，覆盖各品类儿童骑行产品的不同使用场景。",
        viewAudits: "查看安全评测报告",
        morePicks: "更多精选推荐",
        noElectricData: "暂无电动车评测数据，敬请期待",
        sections: {
          joggingTitle: "最佳慢跑婴儿推车",
          joggingDesc: "精选适合旅行与日常步行场景的慢跑婴儿推车，深度测评悬挂避震、轮胎稳定性与收纳便利度。",
          balanceTitle: "最佳平衡车",
          balanceDesc: "专为幼童打造的平衡车测评，聚焦轮胎防滑、防侧翻限位、脚踏高度和 2 岁入门体验。",
          kidsBikeTitle: "最佳儿童自行车",
          kidsBikeDesc: "精选 12-16 英寸儿童自行车，严苛测试制动距离、车架刚度与日常通勤耐用性。",
          scooterTitle: "最佳儿童滑板车（脚滑与电动）",
          scooterDesc: "覆盖脚滑与电动两类儿童滑板车评测，重点聚焦车架强度、转向方式与低速稳定性。",
          electricCarTitle: "最佳儿童电动汽车",
          electricCarDesc: "全方位儿童电动汽车测试，着重实测双向避震、缓启冲阻性、电池管理系统与安全限速。",
        },
      },
      quickScenarios: {
        title: "智能选购场景",
        description: "从平衡车入门到儿童电动汽车进阶，我们按成长阶段和使用场景帮助您快速匹配最佳方案。",
        cards: {
      ...
      faq: {
        badge: "常见问题",
        title: "常见问题与解答",
        description: "为您解答关于各年龄段儿童骑行产品的选择、旅行场景与安全标准问题。",
        items: [
          {
            question: "2 岁宝宝适合哪种平衡车？",
            answer: "优先选择低坐高、轻车架、轮距稳定的平衡车。对于刚开始接触骑行的 2-3 岁孩子，入门款更重要的是容易上手、容易停稳，而不是复杂配置。",
          },
          {
            question: "旅行时怎么选轻便慢跑婴儿推车？",
            answer: "优先看可单手折叠、重量更轻、前轮锁定稳定的慢跑婴儿推车，并确认收纳尺寸适合车尾箱或短途旅行使用。",
          },
          {
            question: "BalanceBikeToddler 如何评估慢跑手推车在全地形高速运动下的避震与制动安全性？",
            answer: "我们在测试慢跑手推车时，会重点检测三个指标：一是前两轮的追踪定位与转向锁定机构（高速慢跑时必须锁定前轮以防剧烈抖动颠覆）；二是充气大橡胶轮胎与高性能避震弹簧在 5 厘米障碍路面上的重力加速度传导（峰值必须限制在 1.0G 以内）；三是手刹与后轮双踩锁死制动的响应时间与减速率控制。",
          },
          {
            question: "如何为不同年龄的幼童精准选配儿童自行车以及规避不安全的刹车系统？",
            answer: "初学者鞍座高度应比脱鞋腿部跨高低 2.5 厘米，以确保双脚平足全落地。在制动系统上，BalanceBikeToddler 强烈反对低端童车配备倒踩脚刹，此类刹车缺乏线性无级阻尼，容易打滑，紧急时刻还会锁死曲柄使车辆失控侧倾。应优选专门针对儿童手掌骨化周期定制、握距不超过 42 毫米的双手短行程闸把系统。",
          },
          {
            question: "三轮滑板车的重力倾斜转向系统真的比普通的双轮滑板车更安全吗？",
            answer: "是的。三轮滑板车采用的重力倾斜转向不仅可以防止幼童在高速转向时发生骤急侧翻或甩飞，还能积极训练孩子脑部前庭系统的本体平衡感知。对于 3 岁以下刚入门的学龄前儿童，宽大低矮的踏板设计与超平稳的三角形分布三轮滑板车是安全性极高的首选，而两轮滑板车则适合平衡能力完备的学龄大童。",
          },
          {
          ...
          },
          {
            ...
            answer: "低价劣质童车为节省开模费用，常粗暴套用成人五通中轴总成。偏宽的脚踏左右偏距会强行拉开儿童大腿骨，踩踏时膝关节被迫向内侧严重扣折（形成内八或 X 型腿趋势），导致髌骨关节面在发育初期的软骨阶段发生不可逆磨损。此外，实心发泡轮胎由于缺少空气微孔弹性吸收，产生的 3.8G 以上高频振荡波会直击大脑、前庭及未发育成熟的椎骨骨骺，干扰神经感知并阻碍发育。",
          },
        ],
      },
      runtimeLabels: {
    ...
    products: {
      ...
      heroTitle: "产品中心：按实测选车",
      heroSubtitle: "覆盖平衡车、自行车、推车与儿童电动车，聚焦安全、操控与场景匹配。",
      ...
      businessCopy: {
        descriptionTemplates: {
          ...
          twinStrollerZh: "双人推车，双座同乘，避震与转向兼顾。{base}",
          twinStrollerEn: "This high-performance Twin Stroller incorporates state-of-the-art shock absorption and premium responsive seating for families with multiples. {base}",
          electricScooterZh: "儿童电动滑板车，限速清晰，制动可控。{base}",
        ...
        generatedSummary: {
          travelZh: "旅行推车方案，轻便易收，适合通勤与外出。",
          travelSystemZh: "旅行推车套装，座椅衔接顺畅，出行更省心。",
          joggerZh: "慢跑推车方案，稳行避震，适配公园与户外路面。",
          twinZh: "双人推车方案，兼顾空间、转向与同乘舒适。",
          balanceZh: "平衡车入门方案，低速好控，助力启蒙骑行。",
          scooterZh: "儿童滑板车方案，转向清晰，短途玩耍更安心。",
          carSeatZh: "安全座椅方案，重在安装适配与侧向防护。",
          defaultZh: "按场景整理的候选车款，便于继续比较重量、价格与配置。",
    ...
    reviews: {
      ...
      businessCopy: {
        ...
        verdictTemplates: {
          ...
          strollerEn: "The {cleanBrand} stroller stands out for highly responsive handling and airplane-friendly folding geometry. Scoring {rating} overall, its multi-terrain suspension is ideal for active parents seeking travel strollers.",
          balanceEn: "Engineering a lightweight solid frame, the {cleanBrand} balance bike ensures stable low-COG ride control and safety steering. Earning a {rating} overall mark, it is perfect for early balance skills training.",
          bikeEn: "Earning a robust {rating} safety rating, this {cleanBrand} kids bicycle features highly consistent brakes and dynamic pedal support, serving as a dependable choice for young riders.",
          defaultEn: "Rigorously validated for framework stiffness, tire grip, and weight capacity, this {cleanBrand} model secures an outstanding {rating} overall score under simulated road test conditions.",
        },
        dynamicCta: {
  ...
  en: {
    home: {
      ...
      heroSubtitle: "From first balance bikes to kids bikes, strollers, scooters, and electric ride-ons, we publish independent safety testing, comparisons, and buying guidance for every stage of children's mobility.",
      heroCta: "FIND YOUR PERFECT RIDE IN 3 STEPS",
      quickCategories: {
        kidsBike: "Best Kids Bikes",
        balanceBike: "Best Balance Bike",
        kidsScooter: "Best Kids Scooters (Kick & Electric)",
        joggingStroller: "Best Jogging Stroller",
      },
      categoryHighlights: {
        eyebrow: "Category Highlights",
        title: "Find the right fit across every stage of kids mobility",
        description: "We compare frame ergonomics and stress tolerances across every category of children's ride-ons — pedal-free starters, first pedal bikes, strollers, scooters, and battery-powered cars.",
        openProductCenter: "Open Product Center",
        featuredTag: "Featured",
      },
      categoryCards: {
        strollerLabel: "Jogging Stroller",
        strollerDesc: "Discover our top-rated jogging stroller picks, rigorously lab-tested for all-terrain suspension, secure braking, and comfort on runs or daily walks.",
        balanceLabel: "Balance Bike",
        balanceDesc: "Find the safest balance bike for your toddler. We evaluate frame weight, tire grip, and ergonomics to help 2-3 year olds start riding with confidence.",
        kidsBikeLabel: "Kids Bikes",
        kidsBikeDesc: "Compare the best 12-inch to 16-inch kids bikes models. Our unbiased reviews focus on braking power, structural geometry, and pedal stability.",
        scooterLabel: "Kids Scooters (Kick & Electric)",
        scooterDesc: "Explore our expertly reviewed kids scooter selection, from first kick scooters to beginner electric models. We test deck strength, steering safety, and beginner-friendly stability.",
        electricCarLabel: "Kids Electric Cars",
        electricCarDesc: "Browse premium battery-powered kids electric cars. We test motor limit safety, speed controls, remote limits, and structural stiffness.",
        carSeatLabel: "Kids Car Seat",
        carSeatDesc: "Explore high-protection infant and kids car seat. We evaluate impact shock absorption, 5-point harness safety, and secure installation.",
      },
      safetyAudits: {
        badge: "Safety Audits Hub",
        title: "Safety Audits: Double-check Before Purchasing",
        description: "Every model in our children's ride-on categories has passed our high-impact stress reviews and safety threshold ratings before it earns a recommendation.",
        ...
        sections: {
          ...
          joggingDesc: "Discover the safest high-performance jogging stroller, evaluated for shock absorption, wheel control, and travel-friendliness.",
          balanceTitle: "Best Balance Bike",
          balanceDesc: "Safest toddler-friendly balance bike. We test handle grips, turning limiters, and frame weights for 2-year-old starters.",
          kidsBikeTitle: "Best Kids Bikes",
          kidsBikeDesc: "Curated 12-16 inch kids bikes models. Rigorously tested for pedal stability, frame geometry, and stopping power.",
          scooterTitle: "Best Kids Scooters (Kick & Electric)",
          scooterDesc: "Safety evaluations across kick and electric kids scooters. We audit deck strength, steering style, and low-speed response for every model.",
          electricCarTitle: "Best Kids Electric Cars",
          electricCarDesc: "Comprehensive evaluations on kids electric cars interactive dual-drive simulation cabins. We audit suspension, smooth start control, and battery cell reliability.",
        },
      },
      quickScenarios: {
      ...
      faq: {
        ...
        description: "Answering your questions on age fit, travel use, balance bike safety, jogging stroller selection, and kids electric cars testing standards.",
        items: [
          {
            question: "What is the best balance bike for a 2 year old?",
            answer: "Choose a lightweight balance bike with a low seat height, stable wheelbase, and easy-to-hold grips. For toddlers just starting out, look for models sized for ages 2-3.",
          },
          {
            question: "How do I choose a lightweight jogging stroller for travel?",
            answer: "Pick a lightweight jogging stroller with one-hand folding, dependable wheel lock, and compact storage size so it works for road trips, daily walks, and travel.",
          },
          {
            question: "At what age can a toddler start using a balance bike?",
            answer: "Typically, toddlers can start using a balance bike around 18 months old, depending on their physical development and coordination.",
          },
          {
            question: "How does BalanceBikeToddler test jogging stroller for all-terrain high-speed suspension and braking safety?",
            answer: "We focus on three critical specs when testing jogging stroller: first, the front wheel tracking lock (essential to prevent speed wobbles during high-speed runs); second, G-force telemetry across 5cm obstacles (ensuring vibration stays below 1.0G on pneumatic rubber tires); third, hand-activated deceleration brakes coupled with reliable parking locks for immediate incline arrests.",
          },
          {
            question: "How to select the right kids bikes and avoid hazardous bicycle braking systems?",
            answer: "Standfoot crotch inseam is the gold standard for sizing kids bikes. For beginners, the minimum saddle height should sit 2.5 cm below their inseam for flat-foot stability, while keeping total bike weight under 30% of your child's body weight. Regarding braking systems, safety audits strongly discourage pedal-back coaster brakes on kids bikes due to lack of modulation and launch-angle lockups; instead, choose specialized hand-brake levers engineered with a short grip-reach (≤42mm) for responsive, progressive stopping power.",
          },
          {
            question: "Are 3-wheel lean-to-steer kids scooter significantly safer than traditional 2-wheelers for toddlers?",
          ...
          {
            question: "How do you test kids electric scooter battery safety and speed limits?",
            answer: "We check battery insulation, overcharge protection, and parental cut-off controls first, then verify that the kids electric scooter speed stays within a beginner-safe range. Our review also looks for stable braking response and predictable low-speed handling.",
          },
          {
            question: "What age is appropriate for a kids electric scooter?",
            answer: "A kids electric scooter is best for children who already have steady balance and steering control. Younger toddlers should begin with a non-electric 3-wheel scooter first, then move up to electric models once they can manage turning, stopping, and posture reliably.",
          },
          {
          ...
          {
            question: "How do low-quality kids bikes and ride-ons cause permanent skeletal and joint strain for a growing child?",
    ...
    products: {
      ...
      heroSubtitle: "Independent lab-tested evaluations for toddler bike, balance bike, stroller, and electric ride-on toys evaluated for safety, durability, and fun.",
    ...
    reviews: {
      ...
      sections: {
        strollerTitle: "Stroller Reviews: Travel Stroller & Jogging Stroller",
      ...
      keywordPills: {
        ...
        balanceBike: "Balance Bike",
        kidsBike: "Toddler Bike",
        kidsScooter: "Kids Electric Scooter",
        kidsElectricCar: "Kids Electric Car",
      },
      businessCopy: {
        fallbackBrandZh: "该高端型号",
