  ...
  zh: {
    home: {
      ...
      categoryCards: {
        ...
        scooterLabel: "儿童滑板车",
        scooterDesc: "探索我们经专业评测的儿童电动滑板车与儿童滑板车系列，重点看踏板强度、转向安全和低速稳定性。",
      ...
      safetyAudits: {
        ...
        description: "下方每一款产品都通过高冲击应力评测与安全阈值评级，覆盖平衡车、儿童自行车、慢跑婴儿推车、儿童电动滑板车与儿童电动汽车的不同使用场景。",
        viewAudits: "查看安全评测报告",
        morePicks: "更多精选推荐",
        ...
        sections: {
          ...
          scooterTitle: "最佳儿童电动滑板车",
          scooterDesc: "针对幼童与大童的儿童电动滑板车评测，重点聚焦重力转向、低速稳定与安全骑行反馈。",
      ...
      faq: {
        badge: "常见问题",
        title: "常见问题与解答",
        description: "为您解答关于平衡车、儿童自行车、慢跑婴儿推车、儿童电动滑板车与儿童电动汽车的年龄选择、旅行场景与安全标准问题。",
        items: [
          {
  ...
  en: {
    home: {
      ...
      quickCategories: {
        ...
        kidsScooter: "Best Kids Electric Scooter",
      ...
      categoryHighlights: {
        ...
        description: "We compare frame ergonomics and stress tolerances for balance bike, kids bikes, jogging stroller, kids electric scooter, and kids electric cars without forcing keyword lists into the headline.",
      ...
      categoryCards: {
        ...
        scooterLabel: "Kids Electric Scooter",
        scooterDesc: "Explore our expertly reviewed kids electric scooter selection. From stable 3-wheelers to agile 2-wheelers, we test deck strength, steering safety, and beginner-friendly stability.",
      ...
      safetyAudits: {
        ...
        description: "Every model across our balance bike, kids bikes, jogging stroller, kids electric scooter, and kids electric cars categories has passed high-impact stress reviews and safety threshold ratings.",
        ...
        sections: {
          ...
          scooterTitle: "Best Kids Electric Scooter",
          scooterDesc: "Robust safety evaluations on kids electric scooter stability and lean-to-steer mechanisms. We audit deck strength and steering response.",
