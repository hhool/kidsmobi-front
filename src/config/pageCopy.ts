...
const PAGE_COPY: Record<Locale, PageCopy> = {
  ...
  en: {
    home: {
      ...
      heroTitle: "BalanceBikeToddler: Trusted Global Reviews on Best Kids Bikes, Strollers & Scooters",
      heroSubtitle: "The best balance bike, kids bikes, kids scooter, strollers & kids electric cars, independently tested for safety and performance.",
      ...
      categoryHighlights: {
        ...
        description: "We compare frame ergonomics and stress tolerances across kids bikes, stroller & jogging stroller and kids scooter parameters.",
      ...
      safetyAudits: {
        ...
        description: "Every model across our kids bikes, balance bike, kids scooter, jogging stroller, and kids electric cars categories has passed high-impact stress reviews and safety threshold ratings.",
        ...
        sections: {
          ...
          joggingDesc: "Discover the safest high-performance jogging stroller, meticulously evaluated for all-terrain shock absorption and stability.",
          balanceTitle: "Best Balance Bike",
          balanceDesc: "Safest toddler-friendly balance bike. We test handle grips, turning limiters, and frame weights.",
