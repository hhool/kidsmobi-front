...
export default function EvaluationsSection({ 
  ...
  return (
    <div id="evaluations_hub" className="space-y-8 animate-fade-in text-left">
      ...
      {/* 🛠️ 模块 3：场景化横向动态对比矩阵区 (Dynamic Comparison Matrix - 置于最末后呈现) */}
      <section id="comparison-matrix" className="bg-slate-950 text-white p-8 sm:p-12 rounded-[48px] max-w-7xl mx-auto shadow-2xl space-y-8 relative overflow-hidden">
        {/* Atmosphere overlays */}
