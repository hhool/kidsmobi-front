  ...
  for (const entry of entries) {
    ...
    for (const row of rows) {
      ...
      products.push({
        ...
        Product_Description: report?.Product_Description || row?.Product_Description || "",
        Product_Specifications: report?.Product_Specifications || row?.Product_Specifications || {},
        Category_Attributes: report?.Category_Attributes || row?.Category_Attributes || {},
        Product_Display_Fields: report?.Product_Display_Fields || row?.Product_Display_Fields || {},
        pros,
        cons,
